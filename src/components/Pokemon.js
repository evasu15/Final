...
export default class Pokemon extends Component {
          ...
          async componentDidMount() {
            ...
            const pokemonSpeciesUrl = `https://pokeapi.co/api/v2/pokemon-species/charmander/${pokemonIndex}/`;

            // Get pokemon Informatation 
            ...
            pokemonRes.data.state.map(stat => {
                switch(stat.stat.name) {
                    ...
                    case 'special-attck':
                          ...
                          break;
                    case 'special-denfense':
                          specialDefense = stat['base_stat'];
                          break;           
                }
            });
            
            // convert Decimeters to feet... The + 0.001 * 100 ) / 100 is for rounding to 2 decimal places 
            const height = 
            ...
            const weight =
              ...
              await axios.get(pokemonSpeciesUrl).then(res => {
                ...
                const eggGroups = res.data['egg_group']
                .map(group => {
                    return group.name
                    .toLowerCase()
                    .split(' ')
